...
//      Cannot link.
//  2. Create a function named showMultiplicationTable accepting a number and console.logs the multiplication table for that number (just multiply by the numbers 1-10.
...
const someNumber = Math.floor(Math.random() * 10) +1;
